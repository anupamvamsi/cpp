...
// array is passed by value // only allowing SIX guesses
void print_STL_Array(std::array<int, 6> guesses, int count) {
  if (count > 1) {
    std::cout << "Your guesses are: \n";

    for (int i = 0; i < count - 1;
         i++)  // "count-1" so that the last answer isn't printed
